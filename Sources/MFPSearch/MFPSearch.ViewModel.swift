...
extension MFPSearch {
    class ViewModel: ObservableObject {
        ...
        let selectedFoodHandler: (MFPProcessedFood) -> ()
        ...
        init(searchText: String = "", selectedFoodHandler: @escaping (MFPProcessedFood) -> ()) {
            self.searchText = searchText
            self.selectedFoodHandler = selectedFoodHandler
